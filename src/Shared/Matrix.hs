...
import Shared.Vector (Vector3D, Vector4D, fromVector)

newtype Matrix3 a = Matrix3 (Vector3D a, Vector3D a, Vector3D a)
newtype Matrix4 a = Matrix4 (Vector4D a, Vector4D a, Vector4D a, Vector4D a)
