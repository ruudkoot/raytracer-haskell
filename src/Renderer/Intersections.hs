...
intersections r (Cube {})     = undefined
intersections r (Cylinder {}) = undefined
intersections r (Sphere {})   = undefined
intersections r (Cone {})     = undefined
intersections r (Plane {})    = undefined